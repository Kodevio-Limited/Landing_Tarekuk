      ...
      <div className="flex w-full justify-center">
        <div className="w-[1768px] max-w-full inline-flex flex-col justify-start items-center gap-16">
          ...
          <div className="self-stretch inline-flex justify-center items-center gap-10">
            <Reveal delay={1}>
              <div className="w-[561px] h-96 relative bg-yellow-50 rounded-[19px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] outline outline-1 outline-offset-[-1px] outline-yellow-400 overflow-hidden card-hover">
