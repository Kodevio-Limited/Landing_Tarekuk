      ...
      <div className="flex w-full justify-center">
        <div className="max-w-full inline-flex items-start gap-[186px]">
          <Reveal>
            <div className="ml-[70px] inline-flex h-[473px] w-[995px] flex-col items-start gap-[53px]">
              ...
              <div className="inline-flex items-center gap-6">
                ...
                <div className="w-60 h-16 px-24 py-4 bg-yellow-400 rounded-[57px] shadow-[0px_4px_16.299999237060547px_11px_rgba(0,0,0,0.12)] inline-flex justify-center items-center gap-0.5 btn-lift cursor-pointer">
          ...
          <Reveal delay={2}>
            ...
            <img className="h-[721px] w-[652px] image-depth" src="/images/cta/waitlist-phone.png" alt="" />
          </Reveal>
        </div>
      </div>
    </section>
